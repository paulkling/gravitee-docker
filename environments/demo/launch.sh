...
main() {
    ...
    pushd $WORKDIR > /dev/null
        ...
        curl -L https://raw.githubusercontent.com/paulkling/gravitee-docker/master/environments/demo/common.yml -o "common.yml"
        curl -L https://raw.githubusercontent.com/paulkling/gravitee-docker/master/environments/demo/docker-compose-local.yml -o "docker-compose-local.yml"
        echo
